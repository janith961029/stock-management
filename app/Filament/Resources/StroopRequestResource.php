...
use App\Filament\Resources\StroopRequestResource\Pages;
use App\Filament\Resources\StroopRequestResource\RelationManagers;
...
class StroopRequestResource extends Resource
{
    protected static ?string $model = StroopRequest::class;
    protected static ?string $navigationGroup = 'OCSO';
    protected static ?int $navigationSort = 1;
    protected static ?string $policy = \App\Policies\StroopRequestPolicy::class;
    protected static ?string $navigationIcon = 'heroicon-o-clipboard-document-check';
    protected static ?string $navigationLabel= 'Stroop Request';
    ...
    public static function getTableQuery(): Builder
{
    ...
    {
        return [
            'index' => Pages\ListStroopRequests::route('/'),
            'create' => Pages\CreateStroopRequest::route('/create'),
            'edit' => Pages\EditStroopRequest::route('/{record}/edit'),
        ];
    }
}

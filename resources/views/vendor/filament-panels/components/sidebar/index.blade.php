...
@php
    ...
    if (! $roleName && $user && method_exists($user, 'getRoleNames')) {
...
>
    ...
    >
        ...
        @if ($roleName)
            <div class="-mx-2 px-2">
                <span class="inline-flex items-center rounded-full bg-amber-100 px-2.5 py-1 text-xs font-semibold uppercase tracking-wide text-amber-900">
                    {{ $roleName }}
                </span>
            </div>
        @endif
